...
//            var hasAttributes = AttributeChecker
//                .HasAttributes(method!, typeof(HttpPostAttribute), typeof(RouteAttribute));
...
////            // Act - Register User
////            var registerResponse = await client.PostAsync("/Identity/Register", registerContent);
...
////            // Act - Login User
////            var loginResponse = await client.PostAsync("/Identity/Register", loginContent);
////            loginResponse.EnsureSuccessStatusCode();

////            // Assert - Verify Notification
////            fixture.NotificationServiceMock.Verify(n => n.SendNotificationToAdmin("success", $"'unique15' Has Just Logged In!"));
////        }
////        //// Arrange
////        //var registerModel = new RegisterServiceModel
////        //{
